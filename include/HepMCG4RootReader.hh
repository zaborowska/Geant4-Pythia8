...
protected:
   ...
   */
   HepMCG4RootReaderMessenger* fMessenger;
   /**
...
inline void HepMCG4RootReader::SetFileName(G4String aName)
{
  fFileName= aName;
}
...
inline void HepMCG4RootReader::SetVerboseLevel(G4int aLevel)
{
  fVerbose= aLevel;
}
